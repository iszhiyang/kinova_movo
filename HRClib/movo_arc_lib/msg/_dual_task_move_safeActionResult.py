...
"""autogenerated by genpy from movo_arc_lib/dual_task_move_safeActionResult.msg. Do not edit."""
import codecs
import sys
...
class dual_task_move_safeActionResult(genpy.Message):
  _md5sum = "0698ce25b2d595b82357c010557e935f"
  _type = "movo_arc_lib/dual_task_move_safeActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','movo_arc_lib/dual_task_move_safeResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(dual_task_move_safeActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = movo_arc_lib.msg.dual_task_move_safeResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = movo_arc_lib.msg.dual_task_move_safeResult()

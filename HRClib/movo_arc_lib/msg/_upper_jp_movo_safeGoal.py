...
"""autogenerated by genpy from movo_arc_lib/upper_jp_movo_safeGoal.msg. Do not edit."""
import codecs
import sys
...
class upper_jp_movo_safeGoal(genpy.Message):
  _md5sum = "df23c7aa89910657a7be03f9c036c267"
  _type = "movo_arc_lib/upper_jp_movo_safeGoal"
...
"""
  __slots__ = ['jp_right','jp_left','jp_linear','jp_head','duration','r_max_force','l_max_force']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       jp_right,jp_left,jp_linear,jp_head,duration,r_max_force,l_max_force
    ...
    """
    if args or kwds:
      super(upper_jp_movo_safeGoal, self).__init__(*args, **kwds)

...
"""autogenerated by genpy from movo_arc_lib/upper_jp_movo_safe_relateAction.msg. Do not edit."""
import codecs
import sys
...
class upper_jp_movo_safe_relateAction(genpy.Message):
  _md5sum = "77ad08a2971500f9ab99fe0324c2394f"
  _type = "movo_arc_lib/upper_jp_movo_safe_relateAction"
...
"""
  ...
  _slot_types = ['movo_arc_lib/upper_jp_movo_safe_relateActionGoal','movo_arc_lib/upper_jp_movo_safe_relateActionResult','movo_arc_lib/upper_jp_movo_safe_relateActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(upper_jp_movo_safe_relateAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = movo_arc_lib.msg.upper_jp_movo_safe_relateActionGoal()
      if self.action_result is None:
        self.action_result = movo_arc_lib.msg.upper_jp_movo_safe_relateActionResult()
      if self.action_feedback is None:
        self.action_feedback = movo_arc_lib.msg.upper_jp_movo_safe_relateActionFeedback()
    else:
      self.action_goal = movo_arc_lib.msg.upper_jp_movo_safe_relateActionGoal()
      self.action_result = movo_arc_lib.msg.upper_jp_movo_safe_relateActionResult()
      self.action_feedback = movo_arc_lib.msg.upper_jp_movo_safe_relateActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      buff.write(_get_struct_7f().pack(*self.action_goal.goal.jp_right_relate))
      buff.write(_get_struct_7f().pack(*self.action_goal.goal.jp_left_relate))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.action_goal.goal.jp_right_relate = _get_struct_7f().unpack(str[start:end])
      start = end
      end += 28
      self.action_goal.goal.jp_left_relate = _get_struct_7f().unpack(str[start:end])
      start = end
      end += 4
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.action_goal.goal.jp_right_relate = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=7)
      start = end
      end += 28
      self.action_goal.goal.jp_left_relate = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=7)
      start = end
      end += 4
      (self.action_goal.goal.jp_linear,) = _get_struct_f().unpack(str[start:end])
      start = end

...
"""autogenerated by genpy from movo_arc_lib/upper_jp_movo_safe_relateGoal.msg. Do not edit."""
import codecs
import sys
...
class upper_jp_movo_safe_relateGoal(genpy.Message):
  _md5sum = "52cdc0dbd2736f0f41212ac9fda72148"
  _type = "movo_arc_lib/upper_jp_movo_safe_relateGoal"
...
"""
  __slots__ = ['jp_right_relate','jp_left_relate','jp_linear','jp_head','duration','r_max_force','l_max_force']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       jp_right_relate,jp_left_relate,jp_linear,jp_head,duration,r_max_force,l_max_force
    ...
    """
    if args or kwds:
      super(upper_jp_movo_safe_relateGoal, self).__init__(*args, **kwds)
